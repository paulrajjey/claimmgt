<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("eClaimOut");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid eClaimOut");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: ClaimProcess.datacorrection
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">eClaimOut</label>
                            		<div class="div_texbox">
                              		<input name="eClaimOut" type="text" class="textbox" id="eClaimOut" value="${eClaimOut}" />
                            		</div>
